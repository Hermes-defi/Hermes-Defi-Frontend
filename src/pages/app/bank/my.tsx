            ...
            <Stack mt={4} direction={["column", "row"]} justify="space-between" spacing={[5, 10]}>
                ...
                <Stack spacing={1}>
                  ...
                  <Skeleton isLoaded={!!depositedAmount.data}>
                    <Text color="primary.400" fontWeight="bold">
                      {displayNumber(depositedAmount.data || 0, false, 3)} APOLLO
                    </Text>
                  </Skeleton>
                </Stack>
              ...
              <Stack flex="1" justify="space-between">
                <Text fontSize="sm" color={useColorModeValue("gray.600", "gray.100")}>
                  Note: Make sure to have enough APOLLO to receive a lottery ticket since the actual amount of APOLLO
                ...
                <Stack mt={5} spacing={3}>
                  ...
                  <Text fontSize="xs" align="center">
                    compound to get 5% bonus APOLLO and lottery ticket
                  </Text>
                </Stack>
              </Stack>
            </Stack>
