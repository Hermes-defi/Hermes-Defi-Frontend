    ...
    <Container maxW={"3xl"}>
      <Stack as={Box} textAlign={"center"} spacing={{ base: 8, md: 10 }} py={{ base: 12, md: 16 }}>
        <Box m="auto" boxSize="30%">
          <Image boxSize="100%" src="/logo.png" alt="logo" />
        </Box>
...
function DappStats() {
  return (
    <Stack justify="center" direction="row" spacing={14}>
      <Box boxShadow="base" px={16} py={10} rounded="md" bg="secondary.200" align="center">
    ...
    <Stack alignItems="center" spacing={6}>
      ...
      <Stack alignItems="stretch" spacing={6} direction="row">
        <Box rounded="sm" boxShadow="base" w="sm" py={12} px={8}>
          <Icon as={GiFarmTractor} boxSize={16} />
        ...
        <Box rounded="sm" boxShadow="base" w="sm" py={12} px={8}>
          <Icon as={RiWaterFlashFill} boxSize={16} />
        ...
        <Box rounded="sm" boxShadow="base" w="sm" py={12} px={8}>
          <Icon as={GiMegaphone} boxSize={16} />
  ...
  return (
    <Stack alignItems="center" spacing={6}>
      ...
      <Stack justify="center" direction="row" spacing={7}>
        <Button isFullWidth variant="solid" colorScheme="secondary" size="lg">
          TechRate
        </Button>
...
const Page = () => {
  return (
    <>
      <Container mb={10} maxWidth="container.xl">
        <Navigation />
        <Header />
