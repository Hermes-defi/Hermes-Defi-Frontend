...
import { useApproveSwapUsdc, useSwapUSDCForApollo, useUsdcApproved } from "hooks/swap";

type Props = {
  isOpen: boolean;
  onClose: () => void;
};
export const BuyApolloModal: React.FC<Props> = (props) => {
  ...
  const buyApollo = useSwapUSDCForApollo();

  const isLoading = approveUSDC.isLoading || buyApollo.isLoading;
  ...
  return (
    <Modal isOpen={props.isOpen} onClose={props.onClose} isCentered>
      ...
      <ModalContent rounded="2xl">
        <ModalCloseButton />
        <ModalHeader fontSize="md">Purchase APOLLO</ModalHeader>
