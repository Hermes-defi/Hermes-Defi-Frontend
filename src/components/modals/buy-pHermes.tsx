...
import { usePlutusBalance, useTokenBalance } from "hooks/wallet";
...
export const BuypHermesModal: React.FC<Props> = (props) => {
  const [amount, setAmount] = useState("");
  // const quotes = usePresaleQuote(amount);
  const balance = usePlutusBalance();
  ...
  return (
    <Modal isOpen={props.isOpen} onClose={props.onClose} isCentered>
      ...
      <ModalContent rounded="2xl">
        <ModalCloseButton />
        <ModalHeader fontSize="md">Purchase pHRMS</ModalHeader>
            ...
            >
              <Box flex="1">
                <Text mb={2} fontSize="xs">
                  Balance: {displayCurrency(balance, true)} PLTS
                </Text>
