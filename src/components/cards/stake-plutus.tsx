...
import { useApproveStakePool, useDepositIntoStakePool, useStakeWithdraw } from "state/stake-plutus";
...
import { PlutusStakeInfo } from "config/stake-plutus";

export const ApoolStakePoolCard: React.FC<{ stakePool: PlutusStakeInfo; isVaultToken?: boolean }> =
            ...
            <Stack direction="row" justify="space-between">
              ...
              <Text fontWeight="700" fontSize="sm">
                {stakePool.totalStaked
                  ? displayTokenCurrency(stakePool.totalStaked, "pPLUTUS")
                  : "N/A"}
              </Text>
            </Stack>
